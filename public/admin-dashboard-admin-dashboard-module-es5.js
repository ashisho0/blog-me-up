...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["admin-dashboard-admin-dashboard-module"], {
  ...
  function node_modulesNgxQuillFesm2015NgxQuillJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var QuillService = /*#__PURE__*/function () {
      function QuillService(config) {
        _classCallCheck2(this, QuillService);
        ...
        value: function getQuill() {
          ...
          if (!this.Quill && this.count === 1) {
            this.$importPromise = new Promise(function (resolve) {
              return Object(tslib__WEBPACK_IMPORTED_MODULE_2__["__awaiter"])(_this2, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                var _this3 = this;
                    ...
                    switch (_context.prev = _context.next) {
                      ...
                      case 2:
                        ...
                        (_a = this.config.customOptions) === null || _a === void 0 ? void 0 : _a.forEach(function (customOption) {
                          var newCustomOption = _this3.Quill["import"](customOption["import"]);

                          newCustomOption.whitelist = customOption.whitelist;

                          _this3.Quill.register(newCustomOption, true, _this3.config.suppressGlobalRegisterWarning);
                        });
                        (_b = this.config.customModules) === null || _b === void 0 ? void 0 : _b.forEach(function (_ref) {
                          var implementation = _ref.implementation,
                              path = _ref.path;

                          _this3.Quill.register(path, implementation, _this3.config.suppressGlobalRegisterWarning);
                        });
                        resolve(this.Quill);
    ...
    var QuillEditorBase = /*#__PURE__*/function () {
      function QuillEditorBase(elementRef, domSanitizer, doc, platformId, renderer, zone, service) {
        ...
        _classCallCheck2(this, QuillEditorBase);
        ...
        this.valueSetter = function (quillEditor, value) {
          ...
          if (format === 'html') {
            if (_this4.sanitize) {
              value = _this4.domSanitizer.sanitize(_angular_core__WEBPACK_IMPORTED_MODULE_1__["SecurityContext"].HTML, value);
            }
        ...
        this.selectionChangeHandler = function (range, oldRange, source) {
          var shouldTriggerOnModelTouched = !range && !!_this4.onModelTouched; // only emit changes when there's any listener

          if (!_this4.onBlur.observers.length && !_this4.onFocus.observers.length && !_this4.onSelectionChanged.observers.length && !shouldTriggerOnModelTouched) {
            return;
          }
          ...
          _this4.zone.run(function () {
            ...
            _this4.onSelectionChanged.emit({
              editor: _this4.quillEditor,
              oldRange: oldRange,
              range: range,
              source: source
        ...
        this.textChangeHandler = function (delta, oldDelta, source) {
          ...
          var text = _this4.quillEditor.getText();

          var content = _this4.quillEditor.getContents();

          var html = _this4.editorElem.querySelector('.ql-editor').innerHTML;

          if (html === '<p><br></p>' || html === '<div><br></div>') {
            html = null;
          }

          var trackChanges = _this4.trackChanges || _this4.service.config.trackChanges;
          var shouldTriggerOnModelChange = (source === 'user' || trackChanges && trackChanges === 'all') && !!_this4.onModelChange; // only emit changes when there's any listener

          if (!_this4.onContentChanged.observers.length && !shouldTriggerOnModelChange) {
            return;
          }

          _this4.zone.run(function () {
            if (shouldTriggerOnModelChange) {
              _this4.onModelChange(_this4.valueGetter(_this4.quillEditor, _this4.editorElem));
            }

            _this4.onContentChanged.emit({
              content: content,
              delta: delta,
              editor: _this4.quillEditor,
              html: html,
        ...
        this.editorChangeHandler = function (event, current, old, source) {
          ...
          if (!_this4.onEditorChanged.observers.length) {
            return;
          } // only emit changes emitted by user interactions
                ...
                switch (_context2.prev = _context2.next) {
                  ...
                  case 4:
                    ...
                    this.zone.runOutsideAngular(function () {
                      _this5.quillEditor = new Quill(_this5.editorElem, {
                        bounds: bounds,
                        debug: debug,
                        formats: formats,
                        modules: modules,
                        ...
                        strict: _this5.strict,
                        theme: _this5.theme || (_this5.service.config.theme ? _this5.service.config.theme : 'snow')
                      });
                    });
                    ...
                    setTimeout(function () {
                      if (_this5.onValidatorChanged) {
                        _this5.onValidatorChanged();
                      }

                      _this5.onEditorCreated.emit(_this5.quillEditor);
                    });
    ...
    var QuillEditorComponent = /*#__PURE__*/function (_QuillEditorBase) {
      _inherits2(QuillEditorComponent, _QuillEditorBase);

      var _super2 = _createSuper2(QuillEditorComponent);
      ...
      function QuillEditorComponent(elementRef, domSanitizer, doc, platformId, renderer, zone, service) {
        ...
        return _super2.call(this, elementRef, domSanitizer, doc, platformId, renderer, zone, service);
      }
      ...
      function QuillViewComponent(elementRef, renderer, zone, service, domSanitizer, platformId) {
        ...
        this.valueSetter = function (quillEditor, value) {
          ...
          if (format === 'text') {
            ...
            if (format === 'html') {
              if (_this9.sanitize) {
                value = _this9.domSanitizer.sanitize(_angular_core__WEBPACK_IMPORTED_MODULE_1__["SecurityContext"].HTML, value);
              }
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAdminDashboardAddArticleAddArticleComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAdminDashboardAddUserAddUserComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAdminDashboardEditArticleEditArticleComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAdminDashboardEditMyProfileEditMyProfileComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAdminDashboardEditUserEditUserComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAdminDashboardViewArticlesViewArticlesComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAdminDashboardViewMyProfileViewMyProfileComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppAdminDashboardViewUsersViewUsersComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAdminDashboardAddArticleAddArticleComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAdminDashboardAddArticleAddArticleComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _services_article_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var AddArticleComponent = /*#__PURE__*/function () {
      function AddArticleComponent(articleService, router) {
        _classCallCheck2(this, AddArticleComponent);
      ...
      _createClass2(AddArticleComponent, [{
        key: "ngOnInit",
        ...
        value: function add() {
          ...
          this.articleService.uploadArticle(this.newArticle, this.uploadArray, 'POST').subscribe(function (data) {
            console.log('Added Successfully');
            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('Blog Added', 'Success').then(function () {
              _this11.router.navigate(['admin/article']);
            });
          }), function (err) {
    ...
    AddArticleComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/admin-dashboard/add-article/add-article.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./add-article.component.scss */
      "./src/app/admin-dashboard/add-article/add-article.component.scss"))["default"]]
    })], AddArticleComponent);
    /***/
  },
  ...
  /***/
  function srcAppAdminDashboardAddUserAddUserComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAdminDashboardAddUserAddUserComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var AddUserComponent = /*#__PURE__*/function () {
      function AddUserComponent(userService, router) {
        _classCallCheck2(this, AddUserComponent);
      ...
      _createClass2(AddUserComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "add",
        value: function add() {
          ...
          this.userService.addUser(this.newUser).subscribe(function (data) {
            console.log('Added Successfully');
            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('User Added', 'Success').then(function () {
              _this12.router.navigate(['admin/user']);
            });
          }), function (err) {
    ...
    AddUserComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/admin-dashboard/add-user/add-user.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./add-user.component.scss */
      "./src/app/admin-dashboard/add-user/add-user.component.scss"))["default"]]
    })], AddUserComponent);
    /***/
  },
  ...
  /***/
  function srcAppAdminDashboardAdminDashboardComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAdminDashboardAdminDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_services_notify_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../shared/services/notify.service */
    "./src/app/shared/services/notify.service.ts");

    var AdminDashboardComponent = /*#__PURE__*/function () {
      function AdminDashboardComponent(router, notifyService) {
        _classCallCheck2(this, AdminDashboardComponent);
      ...
      _createClass2(AdminDashboardComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "logout",
    ...
    AdminDashboardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/admin-dashboard/admin-dashboard.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./admin-dashboard.component.scss */
      "./src/app/admin-dashboard/admin-dashboard.component.scss"))["default"]]
  ...
  function srcAppAdminDashboardAdminDashboardModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _admin_dashboard_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var _edit_article_edit_article_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./edit-article/edit-article.component */
    "./src/app/admin-dashboard/edit-article/edit-article.component.ts");
    /* harmony import */


    var _view_articles_view_articles_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./view-articles/view-articles.component */
    ...
    var _edit_user_edit_user_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./edit-user/edit-user.component */
    "./src/app/admin-dashboard/edit-user/edit-user.component.ts");
    /* harmony import */


    var _view_users_view_users_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    ...
    var _services_article_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./services/article.service */
    "./src/app/admin-dashboard/services/article.service.ts");
    /* harmony import */


    var _shared_services_notify_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ../shared/services/notify.service */
    "./src/app/shared/services/notify.service.ts");
    /* harmony import */


    var _edit_my_profile_edit_my_profile_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./edit-my-profile/edit-my-profile.component */
    "./src/app/admin-dashboard/edit-my-profile/edit-my-profile.component.ts");
    /* harmony import */


    var _view_my_profile_view_my_profile_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./view-my-profile/view-my-profile.component */
    ...
    /*! ngx-spinner */
    "./node_modules/ngx-spinner/fesm2015/ngx-spinner.js"); // services 


    var AdminDashboardModule = function AdminDashboardModule() {
      _classCallCheck2(this, AdminDashboardModule);
    };

    AdminDashboardModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_admin_dashboard_component__WEBPACK_IMPORTED_MODULE_6__["AdminDashboardComponent"], _add_article_add_article_component__WEBPACK_IMPORTED_MODULE_7__["AddArticleComponent"], _edit_article_edit_article_component__WEBPACK_IMPORTED_MODULE_8__["EditArticleComponent"], _view_articles_view_articles_component__WEBPACK_IMPORTED_MODULE_9__["ViewArticlesComponent"], _add_user_add_user_component__WEBPACK_IMPORTED_MODULE_10__["AddUserComponent"], _edit_user_edit_user_component__WEBPACK_IMPORTED_MODULE_11__["EditUserComponent"], _view_users_view_users_component__WEBPACK_IMPORTED_MODULE_12__["ViewUsersComponent"], _edit_my_profile_edit_my_profile_component__WEBPACK_IMPORTED_MODULE_16__["EditMyProfileComponent"], _view_my_profile_view_my_profile_component__WEBPACK_IMPORTED_MODULE_17__["ViewMyProfileComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_5__["DashboardRoutingModule"], ngx_quill__WEBPACK_IMPORTED_MODULE_4__["QuillModule"].forRoot(), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], ngx_spinner__WEBPACK_IMPORTED_MODULE_18__["NgxSpinnerModule"]],
      providers: [_services_user_service__WEBPACK_IMPORTED_MODULE_13__["UserService"], _services_article_service__WEBPACK_IMPORTED_MODULE_14__["ArticleService"], _shared_services_notify_service__WEBPACK_IMPORTED_MODULE_15__["NotifyService"]]
  ...
  function srcAppAdminDashboardDashboardRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _edit_article_edit_article_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./edit-article/edit-article.component */
    "./src/app/admin-dashboard/edit-article/edit-article.component.ts");
    /* harmony import */
    ...
    var _edit_user_edit_user_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./edit-user/edit-user.component */
    "./src/app/admin-dashboard/edit-user/edit-user.component.ts");
    /* harmony import */
    ...
    var _edit_my_profile_edit_my_profile_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./edit-my-profile/edit-my-profile.component */
    "./src/app/admin-dashboard/edit-my-profile/edit-my-profile.component.ts");
    /* harmony import */


    var _view_my_profile_view_my_profile_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./view-my-profile/view-my-profile.component */
    "./src/app/admin-dashboard/view-my-profile/view-my-profile.component.ts"); // Components import
    ...
    var DashboardRoutingModule = function DashboardRoutingModule() {
      _classCallCheck2(this, DashboardRoutingModule);
    };
  ...
  /***/
  function srcAppAdminDashboardEditArticleEditArticleComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAdminDashboardEditArticleEditArticleComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_models_article_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! src/app/models/article.model */
    "./src/app/models/article.model.ts");
    /* harmony import */
    ...
    var EditArticleComponent = /*#__PURE__*/function () {
      function EditArticleComponent(articleService, router, activeRouter, spinner) {
        _classCallCheck2(this, EditArticleComponent);
      ...
      _createClass2(EditArticleComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this13 = this;
        ...
        value: function update() {
          ...
          this.spinner.show();
          this.articleService.uploadArticle(this.updatedArticle, this.uploadArray, 'PUT').subscribe(function (data) {
            _this14.spinner.hide();

            console.log('Updated Successfully');
            sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire('Blog Updated', 'Success').then(function () {
              _this14.router.navigate(['admin/article']);
            });
          }), function (err) {
            _this14.spinner.hide();
    ...
    EditArticleComponent.ctorParameters = function () {
      return [{
        type: _services_article_service__WEBPACK_IMPORTED_MODULE_3__["ArticleService"]
      }, {
        type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]
    ...
    EditArticleComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-edit-article',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./edit-article.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/admin-dashboard/edit-article/edit-article.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./edit-article.component.scss */
      "./src/app/admin-dashboard/edit-article/edit-article.component.scss"))["default"]]
  ...
  /***/
  function srcAppAdminDashboardEditMyProfileEditMyProfileComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAdminDashboardEditMyProfileEditMyProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EditMyProfileComponent", function () {
    ...
    var EditMyProfileComponent = /*#__PURE__*/function () {
      function EditMyProfileComponent(userService, router, activeRouter, spinner) {
        _classCallCheck2(this, EditMyProfileComponent);
      ...
      _createClass2(EditMyProfileComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this15 = this;
        ...
        value: function update() {
          ...
          this.userService.uploadUser(this.editedProfile, this.uploadArray, 'PUT').subscribe(function (data) {
            console.log('Profile Updated Successfully');
            sweetalert2__WEBPACK_IMPORTED_MODULE_6___default.a.fire('Profile Updated', 'Success').then(function () {
    ...
    EditMyProfileComponent.ctorParameters = function () {
      return [{
    ...
    EditMyProfileComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-edit-my-profile',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./edit-my-profile.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/admin-dashboard/edit-my-profile/edit-my-profile.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./edit-my-profile.component.scss */
      "./src/app/admin-dashboard/edit-my-profile/edit-my-profile.component.scss"))["default"]]
  ...
  /***/
  function srcAppAdminDashboardEditUserEditUserComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAdminDashboardEditUserEditUserComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var EditUserComponent = /*#__PURE__*/function () {
      function EditUserComponent(userService, router, activeRouter, spinner) {
        _classCallCheck2(this, EditUserComponent);
      ...
      _createClass2(EditUserComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this17 = this;
        ...
        value: function update() {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire({
            ...
            if (result.value) {
              _this18.userService.editUser(_this18.updatedUser, _this18.userID).subscribe(function (data) {
                console.log("User updated successfully");
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire('Updated!', 'User Details Updated.', 'success').then(function () {
                  _this18.router.navigate(['admin/user']);
                });
    ...
    EditUserComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/admin-dashboard/edit-user/edit-user.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./edit-user.component.scss */
      "./src/app/admin-dashboard/edit-user/edit-user.component.scss"))["default"]]
    })], EditUserComponent);
    /***/
  },
  ...
  /***/
  function srcAppAdminDashboardViewArticlesViewArticlesComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAdminDashboardViewArticlesViewArticlesComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ViewArticlesComponent = /*#__PURE__*/function () {
      function ViewArticlesComponent(articleService, router, spinner) {
        _classCallCheck2(this, ViewArticlesComponent);
      ...
      _createClass2(ViewArticlesComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this19 = this;
        ...
        value: function remove(id) {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire({
            ...
            if (result.value) {
              _this20.articleService.deleteArticle(id).subscribe(function (data) {
                console.log("Deleted successfully");
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire('Deleted!', 'Article Deleted.', 'success'); // this.router.navigate(['/user']);
    ...
    ViewArticlesComponent.ctorParameters = function () {
      return [{
    ...
    ViewArticlesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-view-articles',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./view-articles.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/admin-dashboard/view-articles/view-articles.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./view-articles.component.scss */
      "./src/app/admin-dashboard/view-articles/view-articles.component.scss"))["default"]]
  ...
  /***/
  function srcAppAdminDashboardViewMyProfileViewMyProfileComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAdminDashboardViewMyProfileViewMyProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ViewMyProfileComponent", function () {
      return ViewMyProfileComponent;
    });
    /* harmony import */
    ...
    var ViewMyProfileComponent = /*#__PURE__*/function () {
      function ViewMyProfileComponent() {
        _classCallCheck2(this, ViewMyProfileComponent);

        this.loggedInUser = JSON.parse(localStorage.getItem('user')); // console.log('Logged in user in view my profile',this.loggedInUser)
      }

      _createClass2(ViewMyProfileComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    ViewMyProfileComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-view-my-profile',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./view-my-profile.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/admin-dashboard/view-my-profile/view-my-profile.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./view-my-profile.component.scss */
      "./src/app/admin-dashboard/view-my-profile/view-my-profile.component.scss"))["default"]]
    })], ViewMyProfileComponent);
    /***/
  },
  ...
  /***/
  function srcAppAdminDashboardViewUsersViewUsersComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppAdminDashboardViewUsersViewUsersComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ViewUsersComponent = /*#__PURE__*/function () {
      function ViewUsersComponent(userService, router, spinner) {
        _classCallCheck2(this, ViewUsersComponent);
      ...
      _createClass2(ViewUsersComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this21 = this;
        ...
        value: function remove(id) {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire({
            ...
            if (result.value) {
              _this22.userService.deleteUser(id).subscribe(function (data) {
                console.log("Deleted successfully");
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire('Deleted!', 'User Deleted.', 'success'); // this.router.navigate(['/user']);
    ...
    ViewUsersComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/admin-dashboard/view-users/view-users.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./view-users.component.scss */
      "./src/app/admin-dashboard/view-users/view-users.component.scss"))["default"]]
    })], ViewUsersComponent);
    /***/
  }
}]);
