...
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./services/auth.service */ "./src/app/auth/services/auth.service.ts");
/* harmony import */ var _shared_services_notify_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../shared/services/notify.service */ "./src/app/shared/services/notify.service.ts");
...
AuthModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            _services_auth_service__WEBPACK_IMPORTED_MODULE_7__["AuthService"], _shared_services_notify_service__WEBPACK_IMPORTED_MODULE_8__["NotifyService"]
        ]
    })
], AuthModule);
...
/* harmony import */ var src_app_shared_services_notify_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/shared/services/notify.service */ "./src/app/shared/services/notify.service.ts");
...
let LoginComponent = class LoginComponent {
    constructor(router, notifyService, authService) {
        this.router = router;
...
let RegisterComponent = class RegisterComponent {
    constructor(authService, notifyService, router) {
        this.authService = authService;
        this.notifyService = notifyService;
        this.router = router;
        this.user = new src_app_models_user_model__WEBPACK_IMPORTED_MODULE_3__["User"]({});
